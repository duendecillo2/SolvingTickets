...
const TicketList = () => {
    ...
    const [ticketParaOpinion, setTicketParaOpinion] = useState(null);
    ...
    const ticketFinalized = async () => {
        ...
        try {
            ...
            closeModal();
            setTicketParaOpinion(selectedTicket);
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <div style={{ display: 'flex', gap: '10px' }}>
                                <Button onClick={() => { ticketFinalized(); setIsOpinionModalOpen(true); }} variant="contained" color="success">
                                    <FaCheck />
                                </Button>
            ...
            <Modal open={isOpinionModalOpen} onClose={closeOpinionModal}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: '#1c1c1c', color: '#ffffff', borderRadius: '10px', boxShadow: 24, p: 4, width: '400px', textAlign: 'center' }}>
                    <Typography variant="h6" gutterBottom>
                            Nos ayudaría que opines sobre nuestro administrador: {ticketParaOpinion?.agente || 'Sin asignar'}
                    </Typography>
